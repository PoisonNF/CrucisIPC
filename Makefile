...
# Template: app
# Command: D:\QT\6.4.1\mingw_64\bin\qmake.exe -o Makefile CrucisIPC.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
#############################################################################
...
Makefile: CrucisIPC.pro D:/QT/6.4.1/mingw_64/mkspecs/win32-g++/qmake.conf D:/QT/6.4.1/mingw_64/mkspecs/features/spec_pre.prf \
		...
		D:/QT/6.4.1/mingw_64/mkspecs/features/qtquickcompiler.prf \
	...
	$(QMAKE) -o Makefile CrucisIPC.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
